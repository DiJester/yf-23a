...
extern "C"
{
	...
	*/
	...
	ED_FM_API void ed_fm_set_atmosphere(double h,//altitude above sea level
	...
	*/
	ED_FM_API void ed_fm_set_current_mass_state(double mass,
	...
	called before simulation to set up your environment for the next step
	*/
	ED_FM_API void ed_fm_set_current_state(double ax,//linear acceleration component in world coordinate system
	...
	*/
	ED_FM_API void ed_fm_set_current_state_body_axis(double ax,//linear acceleration component in body coordinate system
	...
	*/
	ED_FM_API bool ed_fm_change_mass(double& delta_mass,
	...
	*/
	ED_FM_API void  ed_fm_set_external_fuel(int	 station,
		double fuel,
		double x,
		double y,
		double z);
