...
extern "C"
{
	...
	body coordinate system system is always X - positive forward ,
											...
											Z - positive to right
	*/
	MOCK_ED_FM_API void ed_fm_add_local_force(double& x, double& y, double& z, double& pos_x, double& pos_y, double& pos_z);
	MOCK_ED_FM_API void ed_fm_add_global_force(double& x, double& y, double& z, double& pos_x, double& pos_y, double& pos_z);
	...
	*/
	MOCK_ED_FM_API bool ed_fm_add_local_force_component(double& x, double& y, double& z, double& pos_x, double& pos_y, double& pos_z);
	MOCK_ED_FM_API bool ed_fm_add_global_force_component(double& x, double& y, double& z, double& pos_x, double& pos_y, double& pos_z);

	MOCK_ED_FM_API void ed_fm_add_global_moment(double& x, double& y, double& z);
	MOCK_ED_FM_API void ed_fm_add_local_moment(double& x, double& y, double& z);
	...
	*/
	MOCK_ED_FM_API bool ed_fm_add_local_moment_component(double& x, double& y, double& z);

	MOCK_ED_FM_API bool ed_fm_add_global_moment_component(double& x, double& y, double& z);

	MOCK_ED_FM_API void ed_fm_simulate(double dt);

	MOCK_ED_FM_API void ed_fm_set_atmosphere(double h,       // altitude above sea level
	...
	*/
	MOCK_ED_FM_API void ed_fm_set_current_mass_state(double mass,
	...
	called before simulation to set up your environment for the next step
	*/
	MOCK_ED_FM_API void ed_fm_set_current_state(double ax,           // linear acceleration component in world coordinate system
	...
	*/
	MOCK_ED_FM_API void ed_fm_set_current_state_body_axis(double ax,      // linear acceleration component in body coordinate system
	...
	input handling
	*/
	MOCK_ED_FM_API void ed_fm_set_command(int command,
		float value);
	/*
	 Mass handling
	...
	*/
	MOCK_ED_FM_API bool ed_fm_change_mass(double& delta_mass,
	...
	*/
	MOCK_ED_FM_API void ed_fm_set_internal_fuel(double fuel);
	/*
		get internal fuel volume
	*/
	MOCK_ED_FM_API double ed_fm_get_internal_fuel();
	/*
		set external fuel volume for each payload station , called for weapon init and on reload
	*/
	MOCK_ED_FM_API void ed_fm_set_external_fuel(int station,
		double fuel,
		double x,
		double y,
		double z);
	...
	*/
	MOCK_ED_FM_API double ed_fm_get_external_fuel();

	MOCK_ED_FM_API void ed_fm_set_draw_args(EdDrawArgument* drawargs, size_t size);
	MOCK_ED_FM_API void ed_fm_configure(const char* cfg_path);

	MOCK_ED_FM_API double ed_fm_get_param(unsigned index);

	/*
	call backs for diffrenrt starting conditions
	*/
	MOCK_ED_FM_API void ed_fm_cold_start();
	MOCK_ED_FM_API void ed_fm_hot_start();
	MOCK_ED_FM_API void ed_fm_hot_start_in_air();

	MOCK_ED_FM_API void ed_fm_set_plugin_data_install_path(const char* path);
	MOCK_ED_FM_API void ed_fm_release();

	MOCK_ED_FM_API bool ed_fm_enable_debug_info();
	MOCK_ED_FM_API void ed_fm_suspension_feedback(int idx, const ed_fm_suspension_info* info);

	MOCK_ED_FM_API void ed_fm_set_surface(double h,     // surface height under the center of aircraft
	...
	MOCK_ED_FM_API int dylanAdd(int a, int b) {
		return a + b;
	}
};
