...
creators[devices.COUNTERMEASURES] = { "avSimpleWeaponSystem", LockOn_Options.script_path ..
"Systems/countermeasures.lua" }
...
indicators[#indicators + 1]       = { "ccControlsIndicatorBase", LockOn_Options.script_path ..
"ControlsIndicator/ControlsIndicator.lua", nil }
indicators[#indicators + 1]       = { "ccIndicator", LockOn_Options.script_path ..
"AN_ARC51/indicator/frequency_labels_init.lua", nil, { { "PNT_RADIO_CENTER", "PNT_RADIO_DOWN", "PNT_RADIO_RIGHT" } } }
