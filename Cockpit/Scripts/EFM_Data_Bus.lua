local optionsData_cockpitShake = get_plugin_option_value("YF-23A", "cockpitShake", "local")
local optionsData_wheelBrakeAssist = get_plugin_option_value("YF-23A", "wheelBrakeAssist", "local")
