...
local LeftSideLead           = 0.4 /
    (GearMainTimeSec)              -- left side main gear leads right side, both opening and closing, by 0.7 seconds
...
function update_gear()
    ...
    if get_hyd_utility_ok() or GEAR_ERR == 1 then
        -- NOSE
        local n_gear_jam_integrity = 1      --efm_data_bus:get_integrity("Nose Gear Jam")
        local n_gear_actuator_integrity = 1 --efm_data_bus:get_integrity("Nose Gear Actuator")
        local normal_nose_gear_extend_speed = gear_nose_extend_increment * n_gear_jam_integrity *
            n_gear_actuator_integrity
        local normal_nose_gear_retract_speed = gear_nose_retract_increment * n_gear_jam_integrity *
            n_gear_actuator_integrity
        ...
        -- LEFT and Right
        local l_gear_jam_integrity = 1      --efm_data_bus:get_integrity("Left Gear Jam")
        local r_gear_jam_integrity = 1      --efm_data_bus:get_integrity("Right Gear Jam")
        local l_gear_actuator_integrity = 1 --efm_data_bus:get_integrity("Left Gear Actuator")
        local r_gear_actuator_integrity = 1 --efm_data_bus:get_integrity("Right Gear Actuator")
