...
function debug_print_electric_system()
    print_message_to_user("primAC:" ..
        tostring(elec_primary_ac_ok:get()) ..
        ",primDC:" .. tostring(elec_primary_dc_ok:get()) .. ",26VAC:" .. tostring(elec_26V_ac_ok:get()) ..
        "primmonAC:" ..
        tostring(elec_mon_primary_ac_ok:get()) ..
        ",afmonAC:" .. tostring(elec_aft_mon_ac_ok:get()) .. ",fwdmonAC:" .. tostring(elec_fwd_mon_ac_ok:get()) ..
