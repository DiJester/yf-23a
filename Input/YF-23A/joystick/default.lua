...
{down = SelectCenter4,               name = _('Weapon Bay Door 4'),            category = _('SU-57 HOTAS')},
{down = SelectCenter5,               name = _('Weapon Bay Door 5'),            category = _('SU-57 HOTAS')},
{down = SelectCenter6,               name = _('Weapon Bay Door 6'),            category = _('SU-57 HOTAS')},
