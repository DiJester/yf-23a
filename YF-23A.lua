	...
	SFM_Data           = {
		aerodynamics = --F15
		{
			...
			table_data =
			{
				...
				{ 0.0, 0.0200, 0.055, 0.198, 0.22,  0.63, 25.0, 1.6 },
				{ 0.2, 0.0200, 0.055, 0.198, 0.22,  2.79, 25.0, 1.6 },
				{ 0.4, 0.0200, 0.055, 0.198, 0.22,  4.71, 25.0, 1.6 },
				{ 0.6, 0.0200, 0.055, 0.198, 0.28,  4.71, 25.0, 1.6 },
