	...
	SFM_Data           = {
		aerodynamics = --F15
		{
			...
			table_data =
			{
				...
				{ 0.0, 0.0163, 0.07,   0.134, 0.042, 0.5,   30.0, 1.60 },
				{ 0.2, 0.0163, 0.07,   0.134, 0.042, 1.9,   30.0, 1.60 },
				{ 0.4, 0.0163, 0.07,   0.134, 0.042, 3.2,   30.0, 1.57 },
				{ 0.6, 0.017,  0.073,  0.128, 0.048, 4.71,  30.0, 1.54 },
				{ 0.7, 0.017,  0.076,  0.12,  0.048, 4.71,  28.6, 1.46 },
				{ 0.8, 0.018,  0.079,  0.123, 0.048, 4.71,  27.3, 1.40 },
				{ 0.9, 0.022,  0.083,  0.155, 0.006, 4.71,  26.0, 1.30 },
				{ 1.0, 0.003,  0.085,  0.18,  0.1,   4.71,  24.6, 1.23 },
				{ 1.1, 0.043,  0.086,  0.201, 0.09,  3.8,   18.0, 1.10 },
				{ 1.2, 0.045,  0.083,  0.210, 0.09,  3.12,  17.0, 1.01 },
				{ 1.3, 0.044,  0.077,  0.235, 0.96,  2.4,   16.0, 0.97 },
				{ 1.4, 0.043,  0.0695, 0.255, 0.136, 1.625, 14.5, 0.95 },
				{ 1.6, 0.042,  0.057,  0.305, 0.21,  1.2,   12.5, 0.80 },
				{ 1.8, 0.042,  0.047,  0.381, 0.37,  0.86,  11.4, 0.65 },
				{ 2.0, 0.041,  0.04,   0.506, 2.5,   0.76,  10.5, 0.52 },
				{ 2.2, 0.041,  0.035,  0.755, 3.3,   0.7,   9.0,  0.40 },
				{ 2.5, 0.039,  0.033,  0.755, 4.5,   0.7,   9.0,  0.40 },
				{ 3.9, 0.038,  0.033,  0.9,   6.0,   0.7,   9.0,  0.40 },
			}, -- end of table_data
		}, -- end of aerodynamics
		engine =
		{
